...
public abstract class Server {
   ...
   * 使用hdfs dfsadmin -refreshCallQueue命令时触发
   */
  ...
  private class Listener extends Thread {
    ...
    /**
     * Responder 线程起着缓冲作用。当有大量响应或网络不佳时，Handler 不能将完整的响应返回客户端，
     * 会在 Responder 的 respondSelector 上注册 OP_WRITE 事件，当监听到写条件时，会唤醒 Responder 返回响应。
     */
